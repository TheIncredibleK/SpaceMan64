...
public static class Scores {
	...
	//save temp score
	public static bool SaveTemp(string name, string track, bool winner){
		
		File.Create (Application.persistentDataPath + tempFileName);
		File.WriteAllText (Application.persistentDataPath + tempFileName, name + "," + track + "," + winner.ToString());
		return true;
	}
	//return temp score
